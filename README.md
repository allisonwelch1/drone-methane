...
By A. A. Author<sup>1</sup>, B. B. Author<sup>1</sup>, & C. C. Author<sup>2</sup>, etc.
...
Acknowledgements
-------
This research was funded by ```<GRANTOR>```. Thanks to ```<FIELD SUPPORT>``` for logistical support. Thanks to our colleagues at ```<ORGANIZATION>``` for their continued support.
